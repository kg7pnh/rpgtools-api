    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('read_me', models.TextField(blank=True, null=True, verbose_name='Read Me')),
                ('url', models.URLField(blank=True, null=True, verbose_name='Website')),
                ('method', models.CharField(choices=[('DELETE', 'DELETE'), ('GET', 'GET'), ('PATCH', 'PATCH'), ('POST', 'POST'), ('PUT', 'PUT')], default='POST', max_length=15, verbose_name='Method')),
                ('api_handler', models.CharField(choices=[('die_roll', 'die_roll'), ('addition', 'addition'), ('average', 'average')], default='/api/v1/die-roll', max_length=150, verbose_name='API Handler')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical Handler',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('read_me', models.TextField(blank=True, null=True, verbose_name='Read Me')),
                ('url', models.URLField(blank=True, null=True, verbose_name='Website')),
                ('input_json', models.TextField(default='{"Place": "Holder"}', verbose_name='Input JSON')),
                ('history_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.TextField(null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('game', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='api.game')),
                ('handler', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='api.handler')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handler', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.handler')),
            ],
            options={
                'verbose_name': 'Action',
